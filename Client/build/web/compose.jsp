...
<!-- start id-form -->
                <form action='send' method='post' onsubmit='return valid(this)'>
                    <table style="float: right;"border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <tr>
                        
                            <th valign="top" >To:</th>
                            <td><input name='reciever' type="text" class="inp-compose" /></td>
                            <td></td>
                    </tr>
                    <tr>
                        
                            <th valign="top">Subject:</th>
                            <td><input name='subject' type="text" class="inp-compose" /></td>
                            <td></td>
                    </tr>
                    <tr>
