...
<div id="table-content">        
    <%
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1 sender-width"><a class="info-tooltip" title="<%=srt.equals("reciever")?"Descending":"Ascending"%>" href="inbox?ind=<%=ind%>&r=<%=r%>&sort=reciever&<%=srt.equals("reciever")?"order=desc":"order=asc"%>">To</a>	</th>
                                ...
                                <%
                                    if(res.next())
                                    {
                                        ...
                                        for(int i=0;res.next();i++)
                                        {
                                            ...
                                            out.print("<td id=reciever"+mid+">"+res.getString("user")+"</td>");
                                            ...
                                            %>
                                            <td><a href="javascript:onSubmit(<%=mid%>,'sent')" title='Delete' class='icon-2 info-tooltip'></a></td>
                                            </tr>
                                            <%
