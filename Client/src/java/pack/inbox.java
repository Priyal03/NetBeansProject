...
public class inbox extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("sort")!=null)
        {
            ...
            ResultSet res=dbobj.Select("message_master","user_master","sender","uid","reciever",String.valueOf(uid)+" and flag=1",order,field);
        ...
        {
            ResultSet res=dbobj.Select("message_master","user_master","sender","uid","reciever",String.valueOf(uid)+" and flag=1","asc","mid");
            request.setAttribute("message_info", res);
