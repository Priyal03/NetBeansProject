    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      db dbobj=new db();     
        ...
        if(request.getParameter("sort")!=null)
        {
            ...
            ResultSet res=dbobj.Select("message_master","user_master","sender","uid","reciever",String.valueOf(uid)+" and flag=0",order,field);
        ...
        {
            ResultSet res=dbobj.Select("message_master","user_master","sender","uid","reciever",String.valueOf(uid)+" and flag=0","asc","mid");
            request.setAttribute("message_info", res);
