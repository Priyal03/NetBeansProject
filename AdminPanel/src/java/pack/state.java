...
public class state extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            ResultSet res=dbobj.Select("state","cid",sid);
            //out.print(sid);
            out.print("<select class='styledselect_form' name='st' onchange='getCity(this);'><option value='' selected='selected' align='center'>Select</option>");
            while(res.next())
            {
